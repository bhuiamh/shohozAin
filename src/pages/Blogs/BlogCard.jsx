...
const BlogCard = () => {
  ...
  return (
    <div className="group w-96 h-auto rounded-t-lg tablet:rounded-t-xl laptop:rounded-2xl overflow-hidden shadow-2xl border-4 border-orange-500 relative">
      <div className="z-10 relative">
        <img className="w-full h-full" src={FaqImage1} alt="" />
      </div>
      <div className="bg-black/10 w-full h-24 backdrop-blur-sm -mt-10 z-20 absolute bottom-0 left-0 px-4 pt-2 group-hover:h-full group-hover:backdrop-blur-md transition-all duration-500">
        ...
        <span className="group-hover:hidden">{`${faqText.substring(0, 120)}...`}</span>  <span className="hidden group-hover:inline">{`${faqText.substring(0, 400)}...`}</span>
