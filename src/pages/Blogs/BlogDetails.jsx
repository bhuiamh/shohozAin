...
const BlogDetails = () => {
  ...
  return (
    <div className="max-w-[1280px] min-h-screen mx-auto mt-24 tablet:mt-32 px-4 tablet:px-0 w-full"> {/* Basic container with padding */}
      <div className="grid grid-cols-1 md:grid-cols-12 gap-4"> {/* Grid layout */}
        <main className="col-span-full md:col-span-8"> {/* Main content area */}
          <article className="shadow rounded-lg overflow-hidden"> {/* Article styling */}
