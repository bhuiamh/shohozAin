  ...
  return (
    <div className="mb-5 mt-5 tablet:mt-24 tablet:mb-10 mx-4 tablet:mx-8">
      ...
      <div className=" tablet:flex laptop:flex-grow laptop:flex-row-reverse tablet:flex-row-reverse tablet:flex-grow items-end">
        ...
        <div className="tablet:w-4/6 w-ful text-base tablet:text-xl  font-semibold">
          ...
          <h1 className="py-1">
            {" "}
            <span className="text-orange-700">সহজ আইনের</span> পক্ষ থেকে আপনাদের
            স্বাগতম। সহজ আইন সবসময় আপনাদেরকে সঠিক সিদ্ধান্ত ও পরামর্শ দিয়ে
            আসছে। আপনাদের সেবা দেওয়ার জন্য আমি প্রতিশ্রুতিবদ্ধ। আমি জানি, আমার
            পেশাগত ব্যস্ততার কারণে আমার কাছ থেকে সেবা পেতে বিঘ্নতা ঘটে। এজন্য
            আমি আন্তরিকভাবে দুঃখিত। আপনার সেবা দেওয়ার ব্যাপারটিকে আরও সুন্দর ও
            নিরবচ্ছিন্ন করার জন্য আমি একটি সুন্দর ব্যবস্থা করেছি। এখন থেকে কিছু
            ফি প্রদানের মাধ্যমে আপনি আমার সাথে খুব সহজেই আমার কাছ থেকে আইনি
            পরামর্শ পেতে পারেন। এই ব্যবস্থার মাধ্যমে আমি আশা করি, আপনারা আরও
            সহজেই আমার সেবা পেতে পারবেন।
          </h1>
